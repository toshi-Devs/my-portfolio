...
function Projects() {
  return (
    <div className='flex flex-col min-h-screen bg-slate-950 border-t-lime-200 border-t-2 py-10'>
        ...
        <h2 className='text-2xl font-bold text-slate-100 mx-10 pb-2'>Projects</h2>
                    ...
                    <div className='grid grid-cols-1 gap-5 sm:grid-cols-2 md:grid-cols-2'>
                        ...
                        <div className='bg-[#1C1C1C] m-3 border-2 border-lime-100 shadow-lg backdrop-blur-md p-5'>
                         {/* Now i will put a link to code and live website on top right of this div */}
                            ...
                            <div className='flex flex-col items-center justify-center space-y-5 pb-5'>
                                ...
                                <div className='flex flex-row space-x-1 gap-1 items-center uppercase font-mono'>
                                    <p className='text-sm font-semibold px-1 border-2 rounded-ee-md text-[#FBD38D] border-[#FBD38D] bg-[#fbd38d29]'> NEXTJS</p>
                                    <p className='text-sm font-semibold px-1 border-2 rounded-ee-md text-[#9DECF9] border-[#9DECF9] bg-[#fbd38d29]'> Typescript</p>
                                    <p className='text-sm font-semibold px-1 border-2 rounded-ee-md text-[#FBB6CE] border-[#FBB6CE] bg-[#fbd38d29]'> TailwindCSS</p>
                                    <p className='text-sm font-semibold px-1 border-2 rounded-ee-md text-[#FAF089] border-[#FAF089] bg-[#fbd38d29]'> Firebase</p>                                    
                                </div>  
                            </div>                          
                        </div>
                        ...
                        <div className='bg-[#1C1C1C] m-3 border-2 border-lime-100 shadow-lg backdrop-blur-md p-5'>
                         {/* Now i will put a link to code and live website on top right of this div */}
                            ...
                            <div className='flex flex-col items-center justify-center space-y-5 pb-5'>
                                ...
                                <div className='flex flex-row space-x-1 gap-1 items-center uppercase font-mono'>
                                    <p className='text-sm font-semibold px-1 border-2 rounded-ee-md text-[#FBD38D] border-[#FBD38D] bg-[#fbd38d29]'> Javascript</p>
                                    <p className='text-sm font-semibold px-1 border-2 rounded-ee-md text-[#D6BCFA] border-[#D6BCFA] bg-[#fbd38d29]'> React</p>
                                    <p className='text-sm font-semibold px-1 border-2 rounded-ee-md text-[#FBB6CE] border-[#FBB6CE] bg-[#fbd38d29]'> CSS</p>
                                    <p className='text-sm font-semibold px-1 border-2 rounded-ee-md text-[#FAF089] border-[#FAF089] bg-[#fbd38d29]'> Firebase</p>  
                                </div>  
                            </div>
                         ...
                         {/* Now i will put a link to code and live website on top right of this div */}
                            ...
                            <div className='flex flex-col items-center justify-center space-y-5 pb-5'>
                                ...
                                <div className='flex flex-row space-x-1 gap-1 items-center uppercase font-mono'>
                                    ...
                                    <p className='text-sm font-semibold px-1 border-2 rounded-ee-md text-[#D6BCFA] border-[#D6BCFA] bg-[#fbd38d29]'> React</p>
                                    <p className='text-sm font-semibold px-1 border-2 rounded-ee-md text-[#FBB6CE] border-[#FBB6CE] bg-[#fbd38d29]'> CSS</p>
                                    <p className='text-sm font-semibold px-1 border-2 rounded-ee-md text-[#FAF089] border-[#FAF089] bg-[#fbd38d29]'> API</p>
                                </div>  
                            </div>                          
                        </div>
